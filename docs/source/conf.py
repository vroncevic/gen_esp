...
version: str = '1.1.0'
release: str = 'https://github.com/vroncevic/gen_esp/releases'
...
htmlhelp_basename: str = 'gen_espdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_esp.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_esp', 'gen_esp Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_esp', 'gen_esp Documentation', author,
    'gen_esp', 'One line description of project.', 'Miscellaneous'
)]
