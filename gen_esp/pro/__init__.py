...
try:
    from gen_esp.pro.read_template import ReadTemplate
    from gen_esp.pro.write_template import WriteTemplate
...
class GenESPPro(FileChecking):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - dunder method for GenESPPro.
    '''

    GEN_VERBOSE = 'GEN_ESP::PRO::GEN_SETUP'
    ...
    def __init__(self, verbose=False):
        ...
        verbose_message(GenESPPro.GEN_VERBOSE, verbose, 'init setup')
    ...
    def gen_setup(self, pro_name, verbose=False):
        ...
        verbose_message(
            GenESPPro.GEN_VERBOSE, verbose, 'generating module', pro_name
        )
