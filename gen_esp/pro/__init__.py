...
Info
    Defines class GenESPPro with attribute(s) and method(s).
    Generates an ESP project structure.
'''
...
class GenESPPro(FileCheck, ProConfig, ProName):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | gen_project - Generates ESP project structure.
    '''

    _GEN_VERBOSE: str = 'GEN_AUTOCONF::PRO::GEN_SETUP'
