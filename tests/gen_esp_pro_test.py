...
Info
    Defines class GenESPProTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of GenESPPro.
Execute
    python3 -m unittest -v gen_esp_pro_test
'''
...
class GenESPProTestCase(TestCase):
    '''
        Defines class GenESPProTestCase with attribute(s) and method(s).
        Creates test cases for checking functionalities of GenESPPro.
        GenESPPro unit tests.
